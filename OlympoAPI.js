...
async function getCharacterInfo(characterName) {
    let html = "";
    let encodedURI = encodeURI(armoryUrl+characterName);
    await request(encodedURI).then(function (htmlString) {
        html = htmlString;
    });
    return html;
}
...
async function getCharacterJSON(characterName) {
    ...
    let name = info[1];
    let guild = cheer("#armory_name > h1 > a").text();
    if(guild === ""){
        guild = "Sin hermandad";
    }
    ...
    mana = mana.split(" ")[1];
    let character = await {name: name, level: lvl, guild: guild, health: health, mana: mana, race: info[3], class: info[4], stats: getCharacterStatsJSON(cheer)};
...
async function getInventoryJSON(characterName) {
    let res = await getCharacterInfo(characterName);
    let cheer = await cheerio.load(res);
    let inventory = {};
    ...
    }else{inventory.head = {id: "", name: "<<Ningún objeto equipado>>"}}
    ...
    }else{inventory.neck = {id: "", name: "<<Ningún objeto equipado>>"}}
    ...
    }else{inventory.shoulder = {id: "", name: "<<Ningún objeto equipado>>"}}
    ...
    }else{inventory.back = {id: "", name: "<<Ningún objeto equipado>>"}}
    ...
    }else{inventory.robe = {id: "", name: "<<Ningún objeto equipado>>"}}
    ...
    }else{inventory.shirt = {id: "", name: "<<Ningún objeto equipado>>"}}
    ...
    }else{inventory.tabard = {id: "", name: "<<Ningún objeto equipado>>"}}
    ...
    }else{inventory.wrists = {id: "", name: "<<Ningún objeto equipado>>"}}
    ...
    }else{inventory.hands = {id: "", name: "<<Ningún objeto equipado>>"}}
    ...
    }else{inventory.waist = {id: "", name: "<<Ningún objeto equipado>>"}}
    ...
    }else{inventory.legs = {id: "", name: "<<Ningún objeto equipado>>"}}
    ...
    }else{inventory.feet = {id: "", name: "<<Ningún objeto equipado>>"}}
    ...
    }else{inventory.finger1 = {id: "", name: "<<Ningún objeto equipado>>"}}
    ...
    }else{inventory.finger2 = {id: "", name: "<<Ningún objeto equipado>>"}}
    ...
    }else{inventory.trinket1 = {id: "", name: "<<Ningún objeto equipado>>"}}
    ...
    }else{inventory.trinket2 = {id: "", name: "<<Ningún objeto equipado>>"}}
    ...
    }else{inventory.mainHand = {id: "", name: "<<Ningún objeto equipado>>"}}
    ...
    }else{inventory.holdable = {id: "", name: "<<Ningún objeto equipado>>"};}
    ...
    }else{inventory.relicOrRanged = {id: "", name: "<<Ningún objeto equipado>>"}}
...
async function getOnlinePlayers(){
    let html = "";
    const url = "http://www.olympowow.com/web/online?is_json_ajax=1";
...
module.exports = {
    ...
    getInventory: async (characterName) => {
        return await getInventoryJSON(characterName);
    },
};
